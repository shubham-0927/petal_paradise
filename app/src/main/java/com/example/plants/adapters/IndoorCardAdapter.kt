...
import com.example.plants.data.IndoorCardData

class IndoorCardAdapter(private val context: Context, private val cardDataList: List<IndoorCardData>) :
    RecyclerView.Adapter<IndoorCardAdapter.ViewHolder>() {
